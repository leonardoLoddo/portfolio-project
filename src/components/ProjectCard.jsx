export default function ProjectCard({ imageUrl, title, description, link }) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center bg-black/60 opacity-0 group-hover:opacity-100 px-4 text-center transition-opacity duration-300">
